...
function main {
   # Set Jira user and group
    ...
    if [ ! -d ${JIRA_INSTALL_DIR}/.install4j ] || [ ! -d ${JIRA_HOME}/data ]; then
        ...
        cp -pr /usr/share/atlassian/jira/driver/mysql-connector-java-5.1.44-bin.jar ${JIRA_INSTALL_DIR}/lib

        # Copy the German Language patch
        cp -pr /usr/share/atlassian/jira/patch/jira-core-language-pack-de_DE-7.7.1.v20180122100646.jar ${JIRA_INSTALL_DIR}/atlassian-jira/WEB-INF/atlassian-bundled-plugins/jira-core-language-pack-de_DE-7.7.1.v20180122100646.jar
